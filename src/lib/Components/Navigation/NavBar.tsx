...
function NavBar() {
  ...
  // component below
  return (
    <nav id='navigation-menu' className={`z-50 fixed h-screen transition-all ease-in-out ${menuOpen ? 'bg-gradient-to-r from-black from-85% to-transparent w-[65%] md:w-[25%] duration-500' : "bg-transparent w-0"} duration-700`} onMouseLeave={() => setMenuOpen(false)}>
