...
function BackBtnOverlay(props:{
    ...
    const {link} = props;
  return (
    <Link href={link} className='fixed top-[5%] left-[80%] bg-slate-200 bg-opacity-35 hover:bg-opacity-5 border-2 border-[#FFD700] rounded-full w-8 justify-items-center'>
