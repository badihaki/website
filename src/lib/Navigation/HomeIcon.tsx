...
function HomeIcon() {
  return (
    <div className='transition-all ease-in-out duration-700 absolute justify-center items-center w-[50px] top-2 left-4 hover:w-[100px] hover:top-4 hover:left-4'>
        <Link href={"/"}>
            <div className='flex transition-all ease-in-out duration-500 bg-slate-300 bg-opacity-15 hover:bg-opacity-25 rounded-full justify-center items-center px-2'>
